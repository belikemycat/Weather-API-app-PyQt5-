#3bc309f50c8c26fb6ff56420c3d2fadf
...
class WeatherApp(QWidget):
    def __init__(self):
        ...
        font_id = QFontDatabase.addApplicationFont("AUGUSTUS.TTF")
    ...
    def get_weather(self):
        api_key = "3bc309f50c8c26fb6ff56420c3d2fadf"
        ...
        try:
            ...
            match responce.status_code:
                ...
                case 401:
                    self.display_error("Unauthiresed \nInvalid API key")
                case 403:
                ...
                case 503:
                    self.display_error("Servis is Unavailable \nServer is down")
                case 504:
